...
# user_quiz_1 = Quiz.create(quiz_name: "Red Hair Don't Care Quiz", user_id: 1)
...
# question1 = QuizQuestion.create(question: "This is the question", quiz_id: 1)
# question2 = QuizQuestion.create(question: "This is also a question", quiz_id: 1)
# question3 = QuizQuestion.create(question: "This is another question", quiz_id: 1)

# answer1 = QuizAnswer.create(answer: "answer1", quiz_question_id: 1)
# answer2 = QuizAnswer.create(answer: "answer2", quiz_question_id: 1)
# answer3 = QuizAnswer.create(answer: "answer3", quiz_question_id: 1)
# answer4 = QuizAnswer.create(answer: "answer1", quiz_question_id: 2)
# answer5 = QuizAnswer.create(answer: "answer2", quiz_question_id: 2)
# answer6 = QuizAnswer.create(answer: "answer3", quiz_question_id: 2)
# answer7 = QuizAnswer.create(answer: "answer1", quiz_question_id: 3)
# answer8 = QuizAnswer.create(answer: "answer2", quiz_question_id: 3)
# answer9 = QuizAnswer.create(answer: "answer3", quiz_question_id: 3)

# attribute1 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 1)
# attribute2 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 2)
# attribute3 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 3)
# attribute4 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 4)
# attribute5 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 5)
# attribute6 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 6)
# attribute7 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 7)
# attribute8 = AnswerAttribute.create(answer_attribute: "attr 1", quiz_answer_id: 8)
